...
import sty from "./PlasmicCartItem.module.css"; // plasmic-import: 6dP1gU2RQBMR/css

import RecycleIcon from "./icons/PlasmicIcon__Recycle"; // plasmic-import: C_g6eeoBpgFg/icon
import Secure2Icon from "./icons/PlasmicIcon__Secure2"; // plasmic-import: tGywJsbkU7MR/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rv3Wq)}
      >
        <PlasmicLink__
          ...
          platform={"nextjs"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___2LIQ)}>
            {renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__brlhV)}>
          {renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ku4Dx)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__g47Yv)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__toQSn)}
        >
          <RecycleIcon
            className={classNames(projectcss.all, sty.svg__ux2Ey)}
            role={"img"}
          />

          <Secure2Icon
            className={classNames(projectcss.all, sty.svg__wKaoO)}
            role={"img"}
          />
        </Stack__>
      </Stack__>
