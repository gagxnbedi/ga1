...
import sty from "./PlasmicPaheHeaderMenuTextDark.module.css"; // plasmic-import: iEB-4Havef_M/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__imhgo)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___8VVrl)}
        >
          <PlasmicLink__
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__v0BUz)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__tv4Jn)}
        >
          <PlasmicLink__
            className={classNames(
              projectcss.all,
