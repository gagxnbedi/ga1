...
import sty from "./PlasmicValue.module.css"; // plasmic-import: 9XSoEqjB1bqp/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: bN9i__HRnQNi/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__qLbgo, {
          [sty.freeBoxcenter__qLbgoKYhiq]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__qLbgoGn0Hs]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox___86NSs)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__cjcyy)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dqYnv, {
          [sty.freeBoxcenter__dqYnvKYhiq]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__dqYnvPZoHn]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__vqhAj, {
            [sty.freeBoxcenter__vqhAjKYhiq]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__vqhAjPZoHn]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__joRnw, {
                  [sty.buttonwithButton__joRnwPZoHn]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__bm8RM)}
                    role={"img"}
                  />
                }
                rounded={true}
