...
import sty from "./PlasmicButton.module.css"; // plasmic-import: D9XrDALLnPou/css
  ...
  return (
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootrounded_colors_black_showEndIcon_size_large]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "colors", "black") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
          [sty.rootrounded_showEndIcon_size_large]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
          ...
          [sty.rootshowEndIcon_size_large]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "size", "large"),
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__sNp0A, {
            [sty.freeBoxcolors_white__sNp0AqolG7]: hasVariant(
              $state,
              "colors",
              "white"
            ),
            [sty.freeBoxiconOnly__sNp0AzLxg1]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__sNp0An2UEu]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__sNp0ASuoeR]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxshowStartIcon_colors_white__sNp0ASuoeRQolG7]:
              hasVariant($state, "colors", "white") &&
              hasVariant($state, "showStartIcon", "showStartIcon"),
            [sty.freeBoxsize_large__sNp0Aow8Nn]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__sNp0AQnu7E]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <MenuIcon
                className={classNames(projectcss.all, sty.svg__khstf)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__iop7Q, {
            [sty.freeBoxshowEndIcon__iop7Qn2UEu]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small__iop7Qqnu7E]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__kT8V5)}
                    role={"img"}
                  />
                ),
                ...
                className: classNames(sty.slotTargetEndIcon, {
                  ...
                  [sty.slotTargetEndIconrounded_colors_black_showEndIcon_size_large]:
                    hasVariant($state, "showEndIcon", "showEndIcon") &&
                    hasVariant($state, "colors", "black") &&
                    hasVariant($state, "size", "large") &&
                    hasVariant($state, "rounded", "rounded"),
