...
import sty from "./PlasmicShopingSection.module.css"; // plasmic-import: HLScY8F9FLDn/css
...
function PlasmicShopingSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column__tJWlu)}>
          <Stack__
            as={"div"}
        ...
        <div className={classNames(projectcss.all, sty.column__kGKl9)}>
          <PlasmicImg__
