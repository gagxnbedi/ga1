...
import sty from "./PlasmicInstagram.module.css"; // plasmic-import: IX1Xf65O6Aw9/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pZ8Nr)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hwIq)}
        >
          <h3
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__x9PBp)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___3MCuS)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__aKi9E)}
            displayHeight={
        ...
        <div className={classNames(projectcss.all, sty.freeBox__kSf7W)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__gjHOa)}
            displayHeight={
              hasVariant(globalVariants, "screen", "mobileOnly")
                ? "100%"
                : "250px"
        ...
        <div className={classNames(projectcss.all, sty.freeBox__kzzX0)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__xQpi9)}
            displayHeight={
              hasVariant(globalVariants, "screen", "mobileOnly")
                ? "100%"
                : "250px"
        ...
        <div className={classNames(projectcss.all, sty.freeBox__twSay)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__x5As)}
            displayHeight={
              hasVariant(globalVariants, "screen", "mobileOnly")
                ? "100%"
                : "250px"
        ...
        <div className={classNames(projectcss.all, sty.freeBox__lNtI1)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__pwGtY)}
            displayHeight={
              hasVariant(globalVariants, "screen", "mobileOnly")
                ? "100%"
                : "250px"
