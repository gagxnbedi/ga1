...
import sty from "./PlasmicCollection.module.css"; // plasmic-import: ZCdjyKIEJTaF/css
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <CategoryMedia
            className={classNames("__wab_instance", sty.categoryMedia__m4Vsg)}
          />
        ),
