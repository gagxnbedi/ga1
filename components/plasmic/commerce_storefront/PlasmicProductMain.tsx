...
import sty from "./PlasmicProductMain.module.css"; // plasmic-import: KgwNR90if1Xd/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___9Ifu9)}
      >
        <h3
        ...
        >
          <ProductTextField
            className={classNames(
              "__wab_instance",
              sty.productTextField___01Sq0
            )}
            field={"name"}
          />
        </h3>
        <div className={classNames(projectcss.all, sty.freeBox__mVd6I)}>
          <ProductTextField
            className={classNames(
              "__wab_instance",
              sty.productTextField___6GZra
            )}
            field={"description"}
          />
        </div>
