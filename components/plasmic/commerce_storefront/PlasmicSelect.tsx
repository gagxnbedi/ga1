...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: mOs9QjAOlM4I/component
import Select__Option from "../../Select__Option"; // plasmic-import: jaIY51VPx0c9/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: EB-ev7yAWlRY/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: w_sQ9IKgvI38/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: WJPody2lyAWl/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: tlFicQjlO0je/icon
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__rFis)}
                      value={"value1"}
                    >
                      {"Option 1"}
                    </Select__Option>
      ...
      props = {
        ...
        children: (
          <React.Fragment>
            ...
            <Select__Option
              className={classNames("__wab_instance", sty.option__soh9Q)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
