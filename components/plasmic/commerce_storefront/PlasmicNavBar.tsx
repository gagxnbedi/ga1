...
import sty from "./PlasmicNavBar.module.css"; // plasmic-import: pgplTJIampbm/css

import CartIcon from "./icons/PlasmicIcon__Cart"; // plasmic-import: fA65pgZpu69c/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jrqrl, {
          [sty.freeBoxfilled__jrqrl9DYp]: hasVariant(
            $state,
            "filled",
            "filled"
          ),
          [sty.freeBoxsearchOpen__jrqrlxFclo]: hasVariant(
            $state,
            "searchOpen",
            "searchOpen"
          )
      ...
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lgCZo)}
        >
          <PlasmicLink__
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9EUr)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qaVlQ, {
            [sty.freeBoxsearchOpen__qaVlQxFclo]: hasVariant(
              $state,
              "searchOpen",
              "searchOpen"
            )
