...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: EB-ev7yAWlRY/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: w_sQ9IKgvI38/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__sSqi)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___27KBk)}
              />
            </React.Fragment>
          ),
          value: args.children
